...
//     return storedResetTime ? new Date(storedResetTime) : new Date().setHours(24, 0, 0, 0); // Default to midnight
//   });
...
//   useEffect(() => {
//     const now = new Date();
//     if (now > new Date(resetTime)) {
//       setPromptCount(0);
//       const nextReset = new Date().setHours(24, 0, 0, 0);
